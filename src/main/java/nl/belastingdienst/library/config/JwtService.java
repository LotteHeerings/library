...
public class JwtService {
    ...
    public String extractEmailUser(String token){
        return extractClaim(token, Claims::getSubject); //subject is always the username or email
    }
    ...
    public String generateToken(
        ...
        return Jwts
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 24)) // second>minute>hour>day
